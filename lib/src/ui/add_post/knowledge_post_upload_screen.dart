...
class KnowledgePostUploadScreen extends StatefulWidget {
  static const routeName = '/add_knowledge_post_screen';

  const KnowledgePostUploadScreen({Key? key}) : super(key: key);

  @override
  _KnowledgePostUploadScreenState createState() =>
      _KnowledgePostUploadScreenState();
}

class _KnowledgePostUploadScreenState extends State<KnowledgePostUploadScreen> {
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                ...
                postUploadProvider.uploadKnowledgePost(
